...
FuelSoap.prototype.soapRequest = function(options, callback) {
	...
	this.AuthClient.getAccessToken(clone(options.auth), function(err, body) {
        ...
        // console.log(":fuel-soap: requestOptions.body:", requestOptions.body);
...
// FuelSoap.prototype.retrieve = function(type, props, options) {
//     console.log("::fuel-soap:: retrieve:");

    // TODO: Factor in Promises

    // var deferred = Q.defer();

    // console.log(":fuel-soap.retrieve: 1 arguments:", arguments);
    // console.log(":fuel-soap.retrieve: 1 options:", options);
	...
	// Added by Stickel - 02/13/2017 | Credited to: Jamie Robertson
	// Credited to: Jamie Robertson - https://github.com/salesforce-marketingcloud/FuelSDK-Node-SOAP/pull/68
	...
	if(arguments.length < 4) {
        ...
        if (options.hasOwnProperty("continueRequest")) {
            // console.log("   >>> 2 continueRequest !!!");
		...
		PerformRequestMsg: {
			...
			'Definitions': {
				'Definition': {
					...
					// Only need CustomerKey passed as prop obj
					"CustomerKey": props
				}
			}
		}
