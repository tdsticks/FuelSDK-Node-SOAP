...
// TODO: Need option to load config from Mongo
...
var SoapClient = new FuelSoap(fuelSDKConfig.options);
...
EtFuelApi.prototype.retrieveDataExtension = function (DataExtName) {
    ...
    console.log("DEObj", DEObj);

    // var CustomerKey = "CUSTOMER KEY DIDN'T WORK FOR ME!";
    // console.log("CustomerKey", CustomerKey);


    // <ObjectType>DataExtensionObject[Campaign_DE]</ObjectType>
    // <Properties>SubscriberKey</Properties>
    // <Properties>EmailAddress</Properties>
    // <Properties>CampaignId</Properties>
    ...
    var options = {
        filter: {
            leftOperand: 'EMAIL_ADDRESS',
            operator: 'equals',
            rightOperand: '{YOUR EMAIL HERE}'
        }
    };
...
//
// Clear the data from a Data Extension
//
EtFuelApi.prototype.clearDataExtension = function (DataExtName) {
    console.log("::et_fuel_api:: clearDataExtension:");

    var deferred = Q.defer();

    // console.log(":clearDataExtension: DataExtName:", DataExtName);

    var action = "ClearData";
    // console.log("action", action);

    // var definition = "DataExtensionObject" + "[" + DataExtName + "]";
    // var definition = { "ObjectID": DataExtName };
    var definition = { "CustomerKey": DataExtName };
    ...
    SoapClient.perform(
        ...
        function (err, response) {
            if (err) {
                console.error("::et_fuel_api:: clearDataExtension:", err);
                deferred.reject(err);
            }
            // console.log(":retrieve: response.body:", response.body);
...
//
// For pulling more data from a DE
//
